...
<body>
    ...
    <script>
        ...
        function salvarObservacaoBanco(id, numPedido) {
            ...
            fetch('../Function/salvar_obs_financeiro.php', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
        ...
        async function liberarPedido(id) {
            const confirmado = await mostrarModalConfirmacao('Enviar pedido para o Pós-venda?');
            if (confirmado) {
