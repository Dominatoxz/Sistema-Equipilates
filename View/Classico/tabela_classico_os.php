...
<body>
                            ...
                            <td>
                                ...
                                if (count($status_acessorios) === 0) {
                                    ...
                                    if ($totalEmbalados === $totalAcess) {
                                        ...
                                        echo '<span class="item-check status-acessorio-coletivo" style="color: ' . ($letraAcess === 'A' ? '#2980b9' : '#27ae60') . '; font-weight: bold; font-size: 30px;">' . $letraAcess . '</span>';
    ...
    <script>
        ...
        function verificarAtualizacoesRapidas() {
            fetch('../../Function/dados_tabelas.php?tela=producao_os_classico')
                .then(res => res.json())
                .then(data => {
                    if (data.success) {
