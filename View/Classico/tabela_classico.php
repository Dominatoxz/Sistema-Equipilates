...
<body>
    ...
    <div class="table-container">
        <table>
            ...
            $equipamentos = [
                ...
                'CARRINHO CLASSICO TAUARI'    => 'Carrinho Tauri',
                'CAD. CLASSICO TAUARI'        => 'Cadilac Tauari',
                'GAIOLA CADILCAC TAUARI'      => 'Gaiola Tauari',
                'REFORMER HIBRIDO'            => 'Reformer Hibrido',
                'CARRINHO CLASSICO HIBRIDO'   => 'Carrinho Hibrido',
                'WUNDA CHAIR'                 => 'Wunda Chair',
                'ELECTRIC CHAIR'              => 'Eletric Chair',
                'ARM CHAIR'                   => 'Arm Chair',
                'LADDER BARREL CLÁSS.'        => 'Lader Barrel',
                'PEDI O POLE'                 => 'Pedi o Pole',
                'WALL UNIT CLÁSSICO'          => 'Wall Unit',
                'TORRE WALL UNIT CLÁSSICO'    => 'Torre Wall Unit',
                'MAT CLÁSSICO'                => 'Mat Clássico',
                'MAT PORTÁTIL'                => 'Mat Portátil',
                'BENCH MAT'                   => 'Bench Mat',
    ...
    <script>
        ...
        function verificarAtualizacoesRapidas() {
            fetch('../../Function/dados_tabelas.php?tela=producao_classico')
                .then(res => res.json())
                .then(data => {
                    if (data.success) {
