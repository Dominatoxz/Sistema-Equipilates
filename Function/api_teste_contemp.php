...
$listaEq = implode(",", array_map([$db, "quote"], array_merge(Sistema::EQUIPAMENTOS_PRINCIPAIS_CONTEMPORANEO, Sistema::ACESSORIOS_CONTEMPORANEO, ["Gaiola Cadilac"])));
$sql = "
    ...
    WHERE t.status != 'Embalado' AND t.equipamento NOT LIKE 'Emb.%' AND t.equipamento IN ({$listaEq}) AND STR_TO_DATE(t.prazo_producao, '%d/%m/%Y') BETWEEN '2026-09-21' AND '2026-09-25'
      AND (
