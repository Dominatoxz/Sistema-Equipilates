...
<head>
   ...
   <style>
        ...
        .btn-filtrar { background: #2980b9; color: white; }
        .btn-filtrar:hover { background: #1f618d; }
        .btn-limpar { background: #e2e3e5; color: #383d41; }
        .btn-limpar:hover { background: #d6d8db; }
        .btn-print { background: #27ae60; color: white; margin-left: auto; }
        .btn-print:hover { background: #219150; }
      
        .btn-voltar { background: #7f8c8d; color: white; font-size: 13px; padding: 8px 16px; height: 35px; }
        .btn-voltar:hover { background: #626567; }
        ...
        .etiqueta-fabrica { border-left: 6mm solid #666666; } 
        .etiqueta-embalagem { border-left: 6mm solid #000000; } 
        ...
        .num-pedido { font-size: 18px; font-weight: bold; color: #000; } 
        .tipo-etiqueta { font-size: 18px; font-weight: bold; text-transform: uppercase; letter-spacing: 0.5px; color: #000; } 
        .etiqueta-titulo { font-size: 13px; font-weight: bold; margin-top: 4px; color: #000; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; } 
        .etiqueta-sub, .etiqueta-cor { font-size: 11px; color: #000; line-height: 14px; } 
        ...
        .barcode { width: 85%; height: 10mm; object-fit: fill; } 
        .id-text { font-family: monospace; font-size: 10px; text-align: center; font-weight: bold; margin-top: 2px; } 
        ...
        @media print {
            ...
            .etiqueta-fabrica { border-left: 6mm solid #666666 !important; } 
            .etiqueta-embalagem { border-left: 6mm solid #000000 !important; } 
        }
    </style>
</head>
<body>
